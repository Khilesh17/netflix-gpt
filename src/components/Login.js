...
const Login = () => {
    ...
    return (
        <div className='bg-movies bg-cover  bg-opacity-50 overflow-x-hidden'>
            <Header />

            <form className="w-8/12 lg:w-5/12 p-12 bg-black mt-24 mb-12 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80">
